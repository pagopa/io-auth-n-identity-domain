import {
  to = module.io_public_apim_api_weu.module.apim_v2_product_public.azurerm_api_management_product.this
...
import {
  to = module.io_public_apim_api_weu.module.apim_v2_product_public.azurerm_api_management_product_policy.this[0]
  id = "/subscriptions/ec285037-c673-4f58-b594-d7c480da4e8b/resourceGroups/io-p-rg-internal/providers/Microsoft.ApiManagement/service/io-p-apim-v2-api/products/io-public-api"
}

import {
  to = module.io_public_apim_api_weu.azurerm_api_management_named_value.io_fn3_public_url_v2
...
import {
  to = module.io_public_apim_api_weu.azurerm_api_management_named_value.io_fn3_public_key_v2
...
import {
  to = module.io_public_apim_api_weu.module.api_v2_public.azurerm_api_management_api.this
...
import {
  to = module.io_public_apim_api_weu.module.api_v2_public.azurerm_api_management_api_policy.this[0]
...
import {
  to = module.io_public_apim_api_weu.module.api_v2_public.azurerm_api_management_product_api.this["io-public-api"]
