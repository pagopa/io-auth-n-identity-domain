...
locals {
  function_lollipop = {
    ...
    app_settings = {
      ...
      LOLLIPOP_ASSERTION_STORAGE_CONTAINER_NAME             = "assertions"
      LOLLIPOP_ASSERTION_STORAGE_FALLBACK_CONNECTION_STRING = "@Microsoft.KeyVault(SecretUri=${azurerm_key_vault_secret.session_st_connection_string.versionless_id})"
      LOLLIPOP_ASSERTION_STORAGE_FALLBACK_CONTAINER_NAME    = local.lollipop_assertions_container_name
