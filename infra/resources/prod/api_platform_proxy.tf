...
import {
  id = "/subscriptions/ec285037-c673-4f58-b594-d7c480da4e8b/resourceGroups/io-p-itn-common-rg-01/providers/Microsoft.ApiManagement/service/io-p-itn-platform-api-gateway-apim-01/namedValues/io-auth-login-acceptance-percentage"
  to = module.io_platform_apim_api_itn.azurerm_api_management_named_value.io_auth_login_acceptance_percentage
}
