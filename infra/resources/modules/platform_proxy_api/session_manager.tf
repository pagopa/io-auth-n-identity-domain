...
module "external_api_session_manager" {
  ...
  content_format = "openapi-link"
  content_value  = "https://raw.githubusercontent.com/pagopa/io-auth-n-identity-domain/refs/tags/io-session-manager%401.27.0/apps/io-session-manager/api/external.yaml"
