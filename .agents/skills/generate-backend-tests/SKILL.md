...
8. If a faithful strategy is credible but harder than a fake, in-memory seam, or narrow stub, ask the user before taking the fallback.
9. After implementation, read `references/final-reporting.md` and add/update the report.
