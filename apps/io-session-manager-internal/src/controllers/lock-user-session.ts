...
export const makeLockUserSessionHandler: H.Handler<
  H.HttpRequest,
    ...
    RTE.chain(({ fiscalCode }) =>
      pipe(
        ...
        RTE.chainW(({ blockedUsersService }) =>
          blockedUsersService.lockUserSession(fiscalCode),
        ),
...
export const LockUserSessionFunction = httpAzureFunction(
  makeLockUserSessionHandler,
);
